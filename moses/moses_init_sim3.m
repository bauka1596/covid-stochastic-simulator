function [param, init] = moses_init_sim3();
%
...
param.br = 0.02/365;      % Daily birth rate
...
param.eps_iso = 0.3;      % Disease transmission rate of isolated compared to the infected
...
param.gamma_mor = 0.4;       % Infected to Dead transition probability
...
param.t_exp = 3;          % Incubation period (The period from the start of incubation to the end of the incubation state
