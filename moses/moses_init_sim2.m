...
param.br = 0.00/365;      % Daily birth rate
param.dr = 0.00/365;      % Daily mortality rate except infected people
param.vr = 0.03;          % Daily vaccination rate (Ratio of susceptible population getting vaccinated)
...
param.qr  = 0.00;         % Daily quarantine rate (Ratio of Exposed getting Quarantined)
param.beta_inf = 0.3;     % Susceptible to infected transition constant
param.ir  = 0.00;         % Daily isolation rate (Ratio of Infected getting Isolated)
...
param.gamma_im = 0;       % Infected to Recovery Immunized transition probability
