function [param, init] = moses_init_lombardy()
%
...
param.beta_exp = 0.2;     % Susceptible to exposed transition constant
...
param.sir  = 0.02;        % Daily severe infected rate (Ratio of Infected getting Severe Infected)
...
param.hosp_capacity = 6000;  % Maximum amount patients that hospital can accommodate

param.gamma_mor = 0.0;      % Infected to Dead transition probability
param.gamma_mor1 = 0.2;    % Severe Infected (Hospitalized) to Dead transition probability
param.gamma_mor2 = 0.3;     % Severe Infected (Not Hospitalized) to Dead transition probability
...
param.sim_len = 150;         % Length of simulation in days
