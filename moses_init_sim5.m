function [param, init] = moses_init_sim5()
%
...
param.beta_exp = 0.01;     % Susceptible to exposed transition constant
...
param.hosp_capacity = 0;  % Maximum amount patients that hospital can accommodate
